...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      <div className="sub">
        Batches A &amp; B (same semester). Enter each subject's LTP load, then generate a
        clash-free schedule with a fixed lunch break between the morning and afternoon sessions.
      </div>
      ...
      <div className="panel">
        <div className="meta-row">
          ...
          <span className="hint">First half = morning, second half = afternoon, lunch in between.</span>
        </div>
